var app = angular.module('app', ['ngRoute', 'ngSanitize', 'pascalprecht.translate'])
  ...
  $translateProvider.translations('ua', {
    ...
    'SR_DESCRIPTION': 'очеш стати крутим діджеєм або класним ведучим?<br>Чи хочеш спробувати себе журналістом?<br>Приходь до нас, молода команда студентського радіо чекає на тебе!',
    'SR_HEAD': 'Семен Лойко',
