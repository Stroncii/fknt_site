...
if(!create_news(array( 'title_uk'=>'Олімпіада за напрямом «Комп’ютерна інженерія»','title_ru'=>'Олимпиада по направлению «Компьютерная инженерия»','title_en'=>'Computer Engineering сompetition', 
